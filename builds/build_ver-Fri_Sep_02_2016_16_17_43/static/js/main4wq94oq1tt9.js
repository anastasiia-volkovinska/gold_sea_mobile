...
var bonuses = function () {
    ...
    function drawBonusLevel() {
        ...
        bonusContainer.addChild(bonusBG, illuminatorContainer, bigFish, upperLight, upperLight2, upperLight3, bonusFG, footerUpBG, footerDownBG, bonusbalanceContainer);
                        ...
                        (function () {
                            var showBonusWinResult = function showBonusWinResult() {
                                ...
                                if (container.getChildByName('currentWinContainer')) {
                                    ...
                                    var currentWinTitle = new createjs.Text('Total Win:', '24px bold Helvetica', '#fff').set({
                                        name: 'currentWinTitle',
                                        textAlign: 'center',
                                        textBaseline: 'middle'
                                    });
                                    var currentWinText = new createjs.Text(bonusData.CurrentWinCoins, '32px bold Helvetica', '#1de4c3').set({
                                        name: 'currentWinText',
                                        y: 0,
                                        textAlign: 'center',
                                        textBaseline: 'middle',
                                    ...
                                    var currentWinContainerWidth = currentWinContainer.getBounds().width;
                                    currentWinText.x = currentWinContainerWidth - currentWinTextWidth / 2;
                                }
...
var freeSpins = function () {
    ...
    function drawFreeSpinsBG() {
        ...
        gameStage.addChild(fsFreeSpinContainer);
    ...
    function countTotalWin(data) {
        ...
        if (data.mode === 'fsBonus') {
            if (stage.getChildByName('fsTotalContainer')) {
                ...
                var fsTotalWinTitle = new createjs.Text('Total Win:', '24px bold Helvetica', '#fff').set({
                ...
                var fsTotalContainerWidth = fsTotalContainer.getBounds().width;
                fsTotalWinText.x = fsTotalContainerWidth - fsTotalWinTextWidth / 2;
            }
        }
    }
    ...
    function addMultiBonus(data) {
        ...
        createjs.Tween.get(multiOsminog).wait(500).to({ x: 0 }, 1200, createjs.Ease.bounceIn);

        createjs.Tween.get(multiVodolaz).wait(1000).to({ x: 1280 - 492 }, 1200, createjs.Ease.bounceIn);

        multiContainer.addChild(multiBG, multiTitle, multiCoins, multiWinText, multiVodolaz, multiOsminog, multiChest, multiButton);
    ...
    function showChests() {
        ...
        chest = new createjs.Bitmap(loader.getResult('chest')).set({ x: 20, y: 350, scaleX: 0.6, scaleY: 0.6 });
...
var login = function () {
    ...
    function initialize() {
        ...
        var gameID = arguments.length <= 2 || arguments[2] === undefined ? 'qo2' : arguments[2];
