    ...
    function countTotalWin(data) {
        ...
        if (data.mode === 'fsBonus') {
            if (stage.getChildByName('fsTotalContainer')) {
                ...
                fsTotalWinTitle.x = fsTotalWinText.x - 20 - fsTotalWinText - fsTotalWinTitle / 2;
                // console.warn('total win measures:', fsTotalWinText.x, fsTotalWinTextWidth, fsTotalWinTitleWidth);
            }
        }
    }
