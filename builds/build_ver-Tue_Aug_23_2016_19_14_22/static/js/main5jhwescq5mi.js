...
var balance = function () {
    ...
    function writeBalance() {
        ...
        balanceContainer.addChild(balanceText.coinsSum, balanceText.coinsCash, balanceText.betSum, balanceText.betCash, balanceText.winCash, balanceText.coinsCashText, balanceText.betCashText, balanceText.winCashText, balanceText.coinsSumText, balanceText.betSumText);
                        ...
                        (function () {
                            var showBonusWinResult = function showBonusWinResult() {
                                ...
                                if (container.getChildByName('currentWinContainer')) {
                                    ...
                                    var currentWinTitle = new createjs.Text('Your Bonus Win:', '24px bold Arial', '#fff').set({
                                        name: 'currentWinTitle',
                                        textAlign: 'center',
                                        textBaseline: 'middle',
                                        shadow: new createjs.Shadow('#C19433', 0, 0, 10)
                                    });
                                    var currentWinText = new createjs.Text(bonusData.CurrentWinCoins, '36px bold Arial', '#fff').set({
                                        name: 'currentWinText',
                                        x: 110,
                                        y: 0,
                                        textAlign: 'center',
...
var freeSpins = function () {
    ...
    function countTotalWin(data) {
        ...
        if (data.mode === 'fsBonus') {
            if (stage.getChildByName('fsTotalContainer')) {
                ...
                var fsTotalWinTitle = new createjs.Text('Total Free Win:', '24px bold Helvetica', '#fff').set({
                    name: 'fsTotalWinTitle',
                    textAlign: 'center',
                    textBaseline: 'middle',
                    shadow: new createjs.Shadow('#fff', 0, 0, 10)
                });
                var fsTotalWinText = new createjs.Text(fsTotalWin, '32px bold Helvetica', '#1de4c3').set({
                    name: 'fsTotalWinText',
                    x: 110,
                    y: 0,
                    textAlign: 'center',
                ...
                var fsWinTitle = new createjs.Text('Win:', '24px bold Helvetica', '#fff').set({
                    x: 190,
                    y: 0,
                    name: 'fsWinTitle',
                    textAlign: 'center',
                ...
                var fsWinText = new createjs.Text(fsWin, '32px bold Helvetica', '#1de4c3').set({
                    name: 'fsWinText',
                    x: 240,
                    y: 0,
                    textAlign: 'center',
    ...
    function vodolazVniz() {
        ...
        // verevka.y += 49;
        // onlyVodolaz.y += 49;
        createjs.Tween.get(verevka).to({ y: verevka.y + 30 }, 1000, createjs.Ease.cubicIn);
        createjs.Tween.get(onlyVodolaz).to({ y: onlyVodolaz.y + 30 }, 1000, createjs.Ease.cubicIn);
...
var lines = function () {
    ...
    function drawTotalWin(win) {
        ...
        if (win) {
            ...
            /* eslint-disable */
            var totalWinText = new createjs.Text(win, 'bold 75px Trajan', '#f0e194').set({
                x: 111,
                y: 70,
                name: 'totalWinText',
                textAlign: 'center',
